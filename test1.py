...
h1Vals=np.array([(2,3.125)],dtype=[('n_assoc','int'),('effectSize','float64')])
#h1Vals=np.array([(1,3.1115),(2,3.125),(4,2.89),(10,2.568),(50,2),(150,1.53),(500,1.3)],dtype=[('n_assoc','int'),('effectSize','float64')]),(800,1.15)
