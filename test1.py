def myMain(parms,mainDef):
    ...
    plotCorr(vY,'vY-{}'.format(yParm))
    myHist(vY[np.triu_indices(numTraits,1)],'vY-hist-{}'.format(yParm))
    ...
    plotCorr(vZ,'vZ-{}'.format(yParm))
    offDiag=vZ[np.triu_indices(numTraits,1)]
    
    myHist(offDiag,'vZ-hist-{}'.format(yParm))
    ...
    stat.plot(stat.monteCarlo(scoreH0),'diagnostics/ellH0Dep-{}'.format(yParm))
    ...
    stat.plot(stat.monteCarlo(scoreH0),'diagnostics/ellH0DepMid-{}'.format(yParm))
    ...
    stat.addRef(stat.gnullScore(z))
    scoreH0=stat.gnullScore(waldH0)
    stat.plot(stat.monteCarlo(scoreH0),'diagnostics/ellH0-{}'.format(yParm))
