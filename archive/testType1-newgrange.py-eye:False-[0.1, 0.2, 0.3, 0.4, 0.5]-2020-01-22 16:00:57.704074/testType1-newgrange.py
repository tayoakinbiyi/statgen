...
DBLog('plotPower')
plotPower(parms)
subprocess.call(['mv','diagnostics/power.png','diagnostics/power-mc.png'])
subprocess.call(['mv','diagnostics/exact.csv','diagnostics/exact-mc.csv'])
...
DBLog('plotPower')
plotPower(parms)    
subprocess.call(['mv','diagnostics/power.png','diagnostics/power-markov.png'])
subprocess.call(['mv','diagnostics/exact.csv','diagnostics/exact-markov.csv'])
